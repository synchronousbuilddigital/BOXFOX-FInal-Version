                                    ...
                                    {filteredCategories.map((cat) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all ${isActive
                                                        ? 'bg-emerald-600 text-white shadow-md shadow-emerald-500/10'
                                                        : 'text-gray-600 hover:text-gray-950 hover:bg-slate-50 border border-transparent hover:border-gray-200/50'
                                                    }`}
                                            >
                                                <span className="truncate pr-2">{cat}</span>
                                                <span className={`text-[10px] font-black px-2 py-0.5 rounded-full shrink-0 ${isActive ? 'bg-emerald-700 text-emerald-100' : 'bg-gray-100 text-gray-500'
                                                    }`}>
                                                    {count}
                                                </span>
                                            </button>
                                    ...
                                    {PRICE_RANGES.map((range) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full flex items-center text-left px-3 py-2.5 rounded-xl text-xs font-bold transition-all border ${isActive
                                            ...
                                            >
                                                <div className={`w-4 h-4 rounded-md border flex items-center justify-center mr-3 transition-colors ${isActive ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-gray-300 bg-white'
                                                    }`}>
                                                    {isActive && <Check size={10} strokeWidth={4} />}
                                                </div>
                                                <span className="grow truncate">{range.label}</span>
                                                <span className={`text-[9px] font-extrabold px-1.5 py-0.5 rounded-md ${isActive ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 text-gray-400'
                                                    }`}>
                                                    {count}
                                                </span>
                                            </button>
                                ...
                                <div className="space-y-1.5">
                                    {SORT_OPTIONS.map((option) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={`w-3.5 h-3.5 rounded-full border-2 flex items-center justify-center mr-3 transition-colors ${isActive ? 'border-emerald-500' : 'border-gray-300 bg-white'
                                                    }`}>
                                        ...
                                        {filteredCategories.map((cat) => {
                                            ...
                                            return (
                                                <button
                                                    key={cat}
                                                    onClick={() => setCategory(cat)}
                                                    className={`px-3 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all text-center truncate flex items-center justify-between ${isActive
                                                            ? 'bg-emerald-600 text-white'
                                                            : 'bg-gray-50 text-gray-600 border border-transparent'
                                                        }`}
                                                >
                                                    <span className="truncate pr-1">{cat}</span>
                                                    <span className={`text-[8px] font-black px-1.5 py-0.5 rounded-full shrink-0 ${isActive ? 'bg-emerald-700 text-emerald-100' : 'bg-gray-200/60 text-gray-500'
                                                        }`}>
                                                        {count}
                                                    </span>
                                                </button>
                                        ...
                                        {PRICE_RANGES.map((range) => {
                                            ...
                                            return (
                                                <button
                                                    key={range.value}
                                                    onClick={() => setPriceRange(range.value)}
                                                    className={`px-3 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all text-left flex items-center justify-between border ${isActive
                                                            ? 'bg-white border-emerald-500 text-emerald-700'
                                                            : 'bg-gray-50 border-transparent text-gray-600'
                                                        }`}
                                                >
                                                    <span className="truncate">{range.label}</span>
                                                    <span className={`text-[8px] font-black px-1.5 py-0.5 rounded-full shrink-0 ${isActive ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-200/60 text-gray-400'
                                                        }`}>
                                                        {count}
                                                    </span>
                                                </button>
                                        ...
                                        {SORT_OPTIONS.map((option) => {
                                            ...
                                            return (
                                                <button
                                                    key={option.value}
                                                    onClick={() => setSortBy(option.value)}
                                                    className={`px-3 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all text-center ${isActive
