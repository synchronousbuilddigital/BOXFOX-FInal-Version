    ...
    if (data._id) {
      ...
      const updatedProduct = await Product.findOneAndUpdate(
        { _id: data._id, vendorId: vendor._id },
        {
          ...
          discountAt10: data.discountAt10 !== undefined && data.discountAt10 !== "" ? parseFloat(data.discountAt10) : undefined,
          discountAt50: data.discountAt50 !== undefined && data.discountAt50 !== "" ? parseFloat(data.discountAt50) : undefined,
          discountAt100: data.discountAt100 !== undefined && data.discountAt100 !== "" ? parseFloat(data.discountAt100) : undefined,
          discountAt500: data.discountAt500 !== undefined && data.discountAt500 !== "" ? parseFloat(data.discountAt500) : undefined,
          discountAt1000: data.discountAt1000 !== undefined && data.discountAt1000 !== "" ? parseFloat(data.discountAt1000) : undefined,
