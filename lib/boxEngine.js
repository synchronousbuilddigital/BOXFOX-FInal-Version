 ...
 */
export function calculateDynamicPrice(qty, p1, p10, p50, p100, p500, p1000, d10, d50, d100, d500, d1000) {
    ...
    for (const tier of tiers) {
        if (q >= tier.qty) {
            ...
            if (hasPrice || hasDiscount) {
                if (hasDiscount) {
                    return Math.round(basePrice * (1 - parseFloat(tier.discount) / 100) * 100) / 100;
                }
                if (hasPrice) {
