...
export function unitPriceFromSixPoints({ priceAt1, priceAt10, priceAt50, priceAt100, priceAt500, priceAt1000 }, qty) {
  const q = Math.max(1, Number(qty) || 1);
  const v1 = Math.max(0, Number(priceAt1 || 0));
  const v10 = Math.max(0, Number(priceAt10 || 0));
  const v50 = Math.max(0, Number(priceAt50 || 0));
  const v100 = Math.max(0, Number(priceAt100 || 0));
  const v500 = Math.max(0, Number(priceAt500 || 0));
  const v1000 = Math.max(0, Number(priceAt1000 || 0));
