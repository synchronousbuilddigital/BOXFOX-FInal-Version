...
export function unitPriceFromSixPoints({ priceAt1, priceAt10, priceAt50, priceAt100, priceAt500, priceAt1000 }, qty) {
  ...
  let v10 = Math.max(0, Number(priceAt10 || 0));
  let v50 = Math.max(0, Number(priceAt50 || 0));
  let v100 = Math.max(0, Number(priceAt100 || 0));
  let v500 = Math.max(0, Number(priceAt500 || 0));
  let v1000 = Math.max(0, Number(priceAt1000 || 0));
